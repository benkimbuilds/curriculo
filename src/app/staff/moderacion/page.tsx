...
export default async function ModerationPage() {
  ...
  return (
    <AppShell userName={session.user.name}><div className="app-content"><PageIntro description="Revisa reportes con contexto. Cada decisión queda registrada." eyebrow="Seguridad de la comunidad" title="Cola de moderación" />
