...
export default async function StaffPage() {
  ...
  return (
    <AppShell userName={session.user.name}><div className="app-content">
      <PageIntro action={<><Link className="button button--ghost" href="/staff/mentoria">Mentoría directa</Link>{canCreateCohort ? <Link className="button button--primary" href="/staff/cohortes/nueva">Nueva cohorte</Link> : undefined}</>} description="Evidencia de avance para las cohortes que tienes asignadas." eyebrow="Equipo facilitador" title="Resumen del programa" />
